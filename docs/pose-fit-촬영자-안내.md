...
1. 카메라를 참가자 눈높이에 맞춤
2. 카메라와 참가자 간 거리는 1.5~2m로 맞춤
3. 화면에 머리부터 발끝, 양쪽 어깨와 손이 모두 보이게 맞춤
...
모든 자세는 카메라 정면을 향한 상태로 촬영. 한 영상에는 자세 하나만 담기. 예: 팔짱
촬영 중 고개 숙이거나 몸 흔들지 않기. 아프거나 어지러우면 바로 중단.
...
1. 한 사람당 자세 하나를 10번씩 촬영
2. 자세 10개 → 한 사람당 총 100개 촬영
3. 한 사람 촬영 시간 약 20~25분
4. 12명 촬영 → 자세마다 120개, 전체 1,200개
