...
> (마지막 갱신: 2026-07-07, 표정 레이어(⑤) 완료 시점 — 마스터리 ⓪①②③⑤⑥ 완료, ④ Eye 마무리만 남음)
...
- 테스트: cd backend && <venv>/python -m pytest tests/ -q  (현재 182 passed, 4 skipped
