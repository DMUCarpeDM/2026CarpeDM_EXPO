...
| Eye-Fit | **홍채 기반 시선 추정 — 수평(머리 자세 보상: 고개를 돌려도 눈이 카메라를 보면 정면) + 수직(눈꺼풀 사이 홍채 위치, 실눈 오작동 구제·아래 훔쳐보기 정밀 감지)** · 듣기/말하기 응시 분리 · 응시 리듬(연속 응시 바우트) · 답변 개시 회피 관용 · **3×3 시선 존 히트맵**(웹 리포트 시각화) · **깜빡임 동역학**(브리핑 개인 기저선 대비 급증 — 절대 임계 폐기) · 이탈 방향·최장 이탈 · 시선 미세 안정성·회복 시간 · **얼굴 다인 가드** | MediaPipe Face Landmarker 478 랜드마크 (브라우저) |
...
| **표정** (관찰) | **진정성 미소 근사(Duchenne — 입만 웃는 미소와 눈까지 웃는 미소 구분)** · **표정 복구 시간**(긴장 표정이 풀리기까지) · 미소 비율 · **미소 타이밍**(압박 질문 교차 판정) · 입술 압축·찡그림(긴장 신호) | Face Landmarker blendshape |
