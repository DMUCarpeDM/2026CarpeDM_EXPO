...
export const homeFitSnapshot = [
  ...
  // 표정 축 전용 일러스트는 아직 없어 IconGlyph(FaceSmile) 폴백을 쓴다 (HomeFitCard).
  { icon: "expression", label: "표정 (Expression-Fit)", short: "표정", score: 84, tone: "expression", text: "상황에 맞게 표정으로 반응해요." },
