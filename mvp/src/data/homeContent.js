...
export const homeFitSnapshot = [
  { label: "응답 (Response-Fit)", short: "응답", score: 82, tone: "response", text: "핵심부터 말하면 더 또렷하게 들려요." },
  { label: "목소리 (Voice-Fit)", short: "목소리", score: 76, tone: "voice", text: "편한 속도로 또렷하게 말해요." },
  { label: "시선 (Eye-Fit)", short: "시선", score: 88, tone: "eye", text: "상대와 자연스럽게 시선을 맞춰요." },
  { label: "자세 (Posture-Fit)", short: "자세", score: 71, tone: "posture", text: "편한 자세로 끝까지 말해봐요." },
];
